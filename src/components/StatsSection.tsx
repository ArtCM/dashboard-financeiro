    ...
    <div className="space-y-6 px-4 lg:px-10 pt-16 container mx-auto">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-row items-center pt-5 lg:pt-0 justify-center gap-3">
          <button className="bg-secondary font-medium w-[204px] lg:w-[254px] h-[37px] text-white px-3 py-3 flex items-center justify-center gap-2 text-sm">
            <span className='flex justify-start'>
              <Image src="/send.png" alt="Adicionar" width={24} height={24} />
            </span>
            Enviar dinheiro
          </button>
          <button className="bg-secondary w-[56px] h-[37px] flex items-center justify-center text-white px-4 py-3">
