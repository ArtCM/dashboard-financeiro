...
![Preview do Projeto](public/projectPreview.png)
...
![alt text](public/previewToast.png)

### Modal de adição de saldo
![alt text](public/addMoneyPreview.png)

### Lista de notificações
![alt text](public/notificationListPreview.png)

### Modal de visualização completa de transações
![alt text](public/transacoesModalPreview.png)

### Modal de visualização completa da Análise geral
![alt text](public/analiseGeralPreview.png)
